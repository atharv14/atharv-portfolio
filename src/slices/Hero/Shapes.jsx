...
function Geometries() {
    const geometries = [
        ...
        },
        {
            position: [-0.8, -0.75, 5],
            r: 0.5,
            geometry: new THREE.TorusGeometry(0.6, 0.3, 16, 32),     // Donut
        },
        {
            position: [1.2, 1.3, -1],
            r: 0.6,
    ...
    const materials = [
        ...
        new THREE.MeshStandardMaterial({ color: 0x8e44ad, roughness: 0.4 }),
    ...
    const soundEffects = [
        ...
        new Audio("/sounds/light1.ogg"),
        new Audio("/sounds/heavy1.ogg"),
        new Audio("/sounds/heavy2.ogg"),
    ];
...
function Geometry({ r, position, geometry, materials, soundEffects }) {
    ...
    function handleClick(e) {
        ...
        // const randomSoundEffectIndex = Math.floor(Math.random() * soundEffects.length);
