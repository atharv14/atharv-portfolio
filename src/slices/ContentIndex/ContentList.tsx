...
export default function ContentList({
    ...
    return (
        <div ref={component}>
                        ...
                        {isFilled.keyText(item.data.title) && (
                            ...
                            >
                                <Link
                                    ...
                                    <span className="ml-auto flex items-center gap-2 text-xl font-medium md:ml-0">{viewMoreText}<MdArrowOutward></MdArrowOutward></span>
                                </Link>
                            </li>
                        )}
                    </>
            ...
            <div className="hover-reveal pointer-none absolute left-0 top-0 -z-10 h-[320px] w-[220px] 
